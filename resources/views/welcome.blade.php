    ...
    <style>
        ...
        @media (max-width: 991px) {
            ...
            .hero-media-right {
                ...
                border-left: 0;
                border-top: none;
                border-bottom: 4px solid var(--vk-saffron);
                border-radius: 0;
                order: 1;
                /* image goes ON TOP */
            }
...
@section('content')
    @php
        ...
        $heroDesc =
            ...
            'Witness the grand evening ritual on the banks of the sacred Ganges. Book private boats, comfortable hotel stays, and custom local cabs for a seamless spiritual journey.';
        $heroImage = $heroSection?->image
            ? asset('storage/' . $heroSection->image)
            : asset('frontend-theme/images/banner/kashi_hero_banner.png');

        $ctaSection = $sections->get('why_choose_us');
        $ctaTitle = $ctaSection?->title ?: 'Book Your Kashi Prayagraj Ayodhya Package';
        $ctaDesc =
            $ctaSection?->description ?:
            'Ready to experience the spiritual triangle? Get customized yatra packages matching your budget.';
        $ctaBgImage = $ctaSection?->image
            ? asset('storage/' . $ctaSection->image)
            ...
            @forelse($banners as $banner)
                <div class="swiper-slide hero-slide-visitkashi">
                    ...
                    <div class="hero-content-left text-white">
                        @if ($banner->title)
                            <div class="mb-4 h1 font-family-poppins fw-extrabold hero-dynamic-title"
                                style="font-size: 38px; line-height: 1.25; font-weight: 800; letter-spacing: -0.5px; color: #ffffff !important;">
                                <span style="color: #fff;">{{ $banner->title }}</span>
                            </div>
                        @endif
                        @if ($banner->subtitle)
                            <div class="mb-4 text-white-50"
                                style="font-size: 14px; line-height: 1.6; max-width: 480px; margin-bottom: 20px; color: rgba(255,255,255,0.75) !important;">
                                {{ $banner->subtitle }}
                            </div>
                        @endif
                        <div class="hero-features-grid">
                            <div class="hero-feature-item">
                                ...
                                <span class="fw-bold" style="font-size: 13px; color: #ffffff !important;">Private
                                    Boats</span>
                            </div>
                            <div class="hero-feature-item">
                                <div class="feature-icon-box"><i class="bi bi-brightness-high"></i></div>
                                <span class="fw-bold" style="font-size: 13px; color: #ffffff !important;">Ganga Aarti
                                    Pooja</span>
                            </div>
                            <div class="hero-feature-item">
                            ...
                            <div class="hero-feature-item">
                                <div class="feature-icon-box"><i class="bi bi-patch-check-fill"></i></div>
                                <span class="fw-bold" style="font-size: 13px; color: #ffffff !important;">Local
                                    Experts</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center text-white-50 border-top pt-3"
                            ...
                            <span>{{ $settings->site_name ?? 'Mahadev Yatra' }} | Most Trusted Travel Partner Since
                                2018</span>
                        </div>
                    </div>
                ...
                <div class="swiper-slide hero-slide-visitkashi">
                    ...
                    <div class="hero-content-left text-white">
                        <div class="mb-4 h1 font-family-poppins fw-extrabold hero-dynamic-title"
                            style="font-size: 38px; line-height: 1.25; font-weight: 800; letter-spacing: -0.5px; color: #ffffff !important;">
                            <span
                                style="color: #fff;">{{ $sections['home_banner']->title ?? 'Experience Divine Kashi' }}</span>
                        </div>
            ...
            <div class="row align-items-center mb-4 w-100">
                <div class="col-12 text-center text-md-start">
                    <span class="text-warning text-uppercase fw-bold"
                        style="font-size:11px; letter-spacing:2px; color: #fff !important;">Spiritual Journeys</span>
                    <h2 class="text-white fw-extrabold mt-1 mb-2"
                        style="font-size: 32px; font-weight: 800; text-shadow: 0 2px 10px rgba(0,0,0,0.25);">Exclusive Tour
                        Packages</h2>
                    <p class="text-white-50 mb-0" style="font-size:14.5px;">Embark on a sacred yatra with our expertly
                        crafted itineraries. Book now on WhatsApp for instant confirmation.</p>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="tour-promo-card">
                        ...
                        <div class="tour-card-content mt-3">
                            ...
                            <p class="tour-promo-desc">Explore ancient ghats, witness grand evening Ganga Aarti, and visit
                                Kashi Vishwanath corridors.</p>
                        </div>
                        <div class="tour-promo-actions">
                            <button type="button" class="tour-promo-btn-itinerary" data-bs-toggle="modal"
                                data-bs-target="#itineraryKashiTour">
                                <i class="bi bi-file-text"></i> Itinerary
                            </button>
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number) }}?text={{ urlencode('Hello, I would like to book the KASHI TOUR (2 N 3D) package. Please provide more information.') }}"
                                target="_blank" class="tour-promo-btn-book">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="tour-promo-card">
                        ...
                        <div class="tour-card-content mt-3">
                            ...
                            <p class="tour-promo-desc">A sacred journey covering Kashi Vishwanath temple, Triveni Sangam in
                                Prayagraj, and Ram Mandir in Ayodhya.</p>
                        </div>
                        <div class="tour-promo-actions">
                            <button type="button" class="tour-promo-btn-itinerary" data-bs-toggle="modal"
                                data-bs-target="#itineraryKashiPrayagrajAyodhya">
                                <i class="bi bi-file-text"></i> Itinerary
                            </button>
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number) }}?text={{ urlencode('Hello, I would like to book the Kashi Prayagraj & Ayodhya Spiritual Tour (3N 4D) package. Please provide more information.') }}"
                                target="_blank" class="tour-promo-btn-book">
                                <i class="bi bi-whatsapp"></i> Book Now
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="tour-promo-card">
                        ...
                        <div class="tour-card-content mt-3">
                            ...
                            <p class="tour-promo-desc">Immerse yourself in the divinity of Baba Vishwanath and the grandeur
                                of Ram Janmabhoomi.</p>
                        </div>
                        <div class="tour-promo-actions">
                            <button type="button" class="tour-promo-btn-itinerary" data-bs-toggle="modal"
                                data-bs-target="#itineraryKashiAyodhya">
                                <i class="bi bi-file-text"></i> Itinerary
                            </button>
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number) }}?text={{ urlencode('Hello, I would like to book the KASHI + AYODHYA (2N 3D) package. Please provide more information.') }}"
                                target="_blank" class="tour-promo-btn-book">
                                <i class="bi bi-whatsapp"></i> Book Now
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="tour-promo-card">
                        ...
                        <div class="tour-card-content mt-3">
                            ...
                            <p class="tour-promo-desc">Perform the ancestral Pinda Daan rituals in Gaya and seek blessings
                                of Lord Kashi Vishwanath.</p>
                        </div>
                        <div class="tour-promo-actions">
                            <button type="button" class="tour-promo-btn-itinerary" data-bs-toggle="modal"
                                data-bs-target="#itineraryKashiGaya">
                                <i class="bi bi-file-text"></i> Itinerary
                            </button>
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number) }}?text={{ urlencode('Hello, I would like to book the KASHI + GAYA (2N 3D) package. Please provide more information.') }}"
                                target="_blank" class="tour-promo-btn-book">
                                <i class="bi bi-whatsapp"></i> Book Now
                            </a>
                        </div>
                        ...
                        @foreach ($testimonials as $t)
                            <div class="swiper-slide h-auto">
                                <div class="testimonial-card-premium">
                                    ...
                                    @if ($t->video_link)
                                        <iframe width="100%" height="250" src="{{ $t->video_link }}"
    ...
    <!-- ITINERARY MODALS -->
    <!-- Modal 1: Kashi Tour -->
    <div class="modal fade" id="itineraryKashiTour" tabindex="-1" aria-labelledby="itineraryKashiTourLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                ...
                <div class="modal-body p-4" style="background: #fdfbf7;">
                    <div class="timeline-wrapper position-relative ps-4 border-start border-2 border-warning"
                        style="border-color: #F57C00 !important; margin-left: 10px;">
                        <!-- Day 1 -->
                        <div class="timeline-item mb-4 position-relative">
                            <div class="timeline-dot position-absolute bg-warning rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                                style="width: 28px; height: 28px; left: -39px; top: 0; background-color: #F57C00 !important; font-size: 12px;">
                                1</div>
                            <h6 class="fw-bold text-dark mb-1">Day 1: Arrival, Hotel Check-in & Evening Ganga Aarti</h6>
                            <p class="text-muted small">Arrive at Varanasi Airport/Junction. Our driver will pick you up
                                and transfer you to the hotel. After check-in, rest for a while. In the evening, witness the
                                divine Ganga Aarti at Dashashwamedh Ghat from a private boat cruise.</p>
                        </div>
                        <!-- Day 2 -->
                        <div class="timeline-item mb-4 position-relative">
                            <div class="timeline-dot position-absolute bg-warning rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                                style="width: 28px; height: 28px; left: -39px; top: 0; background-color: #F57C00 !important; font-size: 12px;">
                                2</div>
                            <h6 class="fw-bold text-dark mb-1">Day 2: Kashi Vishwanath Darshan, Heritage Temples & Sarnath
                                Excursion</h6>
                            <p class="text-muted small">Early morning, proceed for VIP Darshan at Kashi Vishwanath Temple
                                (Golden Temple), Annapurna Temple, and Vishalakshi Temple. Return to hotel for breakfast.
                                Afterwards, drive to Sarnath—the holy place where Lord Buddha gave his first sermon. Visit
                                Dhamek Stupa, Chaukhandi Stupa, and the archaeological museum.</p>
                        </div>
                        <!-- Day 3 -->
                        <div class="timeline-item position-relative">
                            ...
                            <p class="text-muted small">Experience the mystical morning rituals ("Subah-e-Banaras") at Assi
                                Ghat, featuring traditional Vedic chanting and morning Aarti. Post breakfast, visit Sankat
                                Mochan Temple, Durga Temple, and Birla Vishwanath Temple (BHU). After some local shopping
                                for Banarasi Silk, drop off at Varanasi Airport/Junction for departure.</p>
                        </div>
                    </div>

                    <div class="alert alert-warning border-0 d-flex align-items-start gap-3 mt-4"
                        style="background-color: rgba(245, 124, 0, 0.08); border-radius: 12px;">
                        <i class="bi bi-info-circle-fill text-warning fs-5" style="color: #F57C00 !important;"></i>
                        <div class="small text-dark">
                            <strong>Package Inclusions:</strong> AC cab for all transfers & sightseeing, hotel accommodation
                            with daily breakfast, private boat ride for Aarti, and VIP temple darshan assistance.
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-0 p-3 bg-light d-flex justify-content-between">
                    ...
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number) }}?text={{ urlencode('Hello, I would like to book the KASHI TOUR (2 N 3D) package. Please provide more information.') }}"
                        target="_blank" class="btn text-white px-4 py-2"
                        style="background-color: #25D366; border-radius: 8px; font-weight: 700; display: inline-flex; align-items: center; gap: 8px;">
    ...
    <div class="modal fade" id="itineraryKashiPrayagrajAyodhya" tabindex="-1"
        aria-labelledby="itineraryKashiPrayagrajAyodhyaLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                <div class="modal-header text-white border-0 py-3 px-4"
                    style="background: linear-gradient(135deg, #F57C00 0%, #E65100 100%);">
                ...
                <div class="modal-body p-4" style="background: #fdfbf7;">
                    <div class="timeline-wrapper position-relative ps-4 border-start border-2 border-warning"
                        ...
                        <div class="timeline-item mb-4 position-relative">
                            ...
                            <p class="text-muted small">On arrival at Varanasi, pick up and check-in to your hotel. Evening
                                boat ride on the holy Ganges to witness the grand evening Aarti at Dashashwamedh Ghat.
                        ...
                        <div class="timeline-item mb-4 position-relative">
                            <div class="timeline-dot position-absolute bg-warning rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                                style="width: 28px; height: 28px; left: -39px; top: 0; background-color: #F57C00 !important; font-size: 12px;">
                                2</div>
                            <h6 class="fw-bold text-dark mb-1">Day 2: Varanasi Temple Tour & Drive to Prayagraj & Ayodhya
                            </h6>
                            <p class="text-muted small">Early morning VIP darshan at Shri Kashi Vishwanath Temple,
                                Annapurna Temple, and Kaal Bhairav. Return to hotel for breakfast, then drive to Prayagraj.
                                Enjoy holy bath at Triveni Sangam (Confluence of Ganga, Yamuna & mythical Saraswati), and
                                visit Bade Hanuman Temple and Anand Bhawan. Later, drive to Ayodhya. Overnight stay in
                                Ayodhya.</p>
                        </div>
                        <!-- Day 3 -->
                        <div class="timeline-item mb-4 position-relative">
                            ...
                            <p class="text-muted small">After breakfast, visit the grand Ram Janmabhoomi Temple, Hanuman
                                Garhi, Kanak Bhawan, and Dashrath Mahal. Witness the serenity of Saryu River. In the
                                afternoon, drive back to Varanasi. Overnight stay in Varanasi.</p>
                        </div>
                        <!-- Day 4 -->
                        <div class="timeline-item position-relative">
                            <div class="timeline-dot position-absolute bg-warning rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                            ...
                            <p class="text-muted small">After breakfast, check-out and take a tour of Sarnath (Buddhist
                                monument site). If time permits, visit the local markets for Banarasi sarees and drop at
                                airport/railway station for your onward journey.</p>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-warning border-0 d-flex align-items-start gap-3 mt-4"
                        ...
                        <i class="bi bi-info-circle-fill text-warning fs-5" style="color: #F57C00 !important;"></i>
                        <div class="small text-dark">
                            <strong>Package Inclusions:</strong> AC Cab for Varanasi-Prayagraj-Ayodhya transport,
                            accommodation in 3-star hotels with breakfast, VIP darshan passes, and private boat rides.
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-0 p-3 bg-light d-flex justify-content-between">
    ...
    <div class="modal fade" id="itineraryKashiAyodhya" tabindex="-1" aria-labelledby="itineraryKashiAyodhyaLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                <div class="modal-header text-white border-0 py-3 px-4"
                ...
                <div class="modal-body p-4" style="background: #fdfbf7;">
                    <div class="timeline-wrapper position-relative ps-4 border-start border-2 border-warning"
                        ...
                        <div class="timeline-item mb-4 position-relative">
                            <div class="timeline-dot position-absolute bg-warning rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                                ...
                                1</div>
                            <h6 class="fw-bold text-dark mb-1">Day 1: Arrival & Evening Ganga Aarti in Varanasi</h6>
                            <p class="text-muted small">Arrival at Varanasi and transfer to your hotel. In the evening,
                                witness the glorious Ganga Aarti from a boat cruise. Overnight stay in Varanasi.</p>
                        </div>
                        <!-- Day 2 -->
                        <div class="timeline-item mb-4 position-relative">
                            <div class="timeline-dot position-absolute bg-warning rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                            ...
                            <p class="text-muted small">Early morning VIP Darshan at Kashi Vishwanath temple, Annapurna
                                Temple, and Kaal Bhairav. Return for breakfast, then check out and drive to Ayodhya (approx.
                                4 hours). Check-in at your hotel in Ayodhya. In the evening, attend the Saryu River Aarti
                                and experience the local heritage streets. Overnight stay in Ayodhya.</p>
                        </div>
                        <!-- Day 3 -->
                        <div class="timeline-item position-relative">
                            <div class="timeline-dot position-absolute bg-warning rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                            ...
                            <p class="text-muted small">Seek blessings at the Ram Janmabhoomi Temple, Hanuman Garhi, and
                                Kanak Bhawan. After lunch, check-out and return to Varanasi. We will drop you off at the
                                Airport/Junction for departure.</p>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-warning border-0 d-flex align-items-start gap-3 mt-4"
                        ...
                        <i class="bi bi-info-circle-fill text-warning fs-5" style="color: #F57C00 !important;"></i>
                        <div class="small text-dark">
                            <strong>Package Inclusions:</strong> Private AC vehicle, hotel stays in Varanasi and Ayodhya,
                            breakfast, boat ride in Varanasi, and priority entry assistance for darshans.
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-0 p-3 bg-light d-flex justify-content-between">
    ...
    <!-- Modal 4: Kashi + Gaya -->
    <div class="modal fade" id="itineraryKashiGaya" tabindex="-1" aria-labelledby="itineraryKashiGayaLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                <div class="modal-header text-white border-0 py-3 px-4"
                ...
                <div class="modal-body p-4" style="background: #fdfbf7;">
                    <div class="timeline-wrapper position-relative ps-4 border-start border-2 border-warning"
                        ...
                        <div class="timeline-item mb-4 position-relative">
                            ...
                            <h6 class="fw-bold text-dark mb-1">Day 1: Arrival & Evening Ganga Aarti in Varanasi</h6>
                            <p class="text-muted small">Arrival at Varanasi and transfer to your hotel. In the evening,
                                witness the famous Ganga Aarti at Dashashwamedh Ghat from a private boat. Overnight stay in
                                Varanasi.</p>
                        </div>
                        <!-- Day 2 -->
                        <div class="timeline-item mb-4 position-relative">
                            <div class="timeline-dot position-absolute bg-warning rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                                style="width: 28px; height: 28px; left: -39px; top: 0; background-color: #F57C00 !important; font-size: 12px;">
                                2</div>
                            <h6 class="fw-bold text-dark mb-1">Day 2: Varanasi Temple Darshan & Drive to Gaya & Bodhgaya
                            </h6>
                            <p class="text-muted small">Early morning VIP Darshan at Kashi Vishwanath temple, Annapurna
                                Temple, and Kaal Bhairav. Return for breakfast, then drive to Gaya (approx. 5-6 hours). In
                                Gaya, visit the holy Vishnupad Temple to perform Pind Daan (ancestral rites) if desired.
                                Later, visit Bodhgaya—where Lord Buddha attained enlightenment. Visit the Mahabodhi Temple,
                                the sacred Bodhi Tree, and various international monasteries. Overnight stay in Bodhgaya.
                            </p>
                        </div>
                        <!-- Day 3 -->
                        <div class="timeline-item position-relative">
                            ...
                            <p class="text-muted small">After breakfast, check out and drive back to Varanasi. Enjoy quick
                                shopping for silk garments and drop-off at the Airport/Junction for your departure
                                flight/train.</p>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-warning border-0 d-flex align-items-start gap-3 mt-4"
                        ...
                        <i class="bi bi-info-circle-fill text-warning fs-5" style="color: #F57C00 !important;"></i>
                        <div class="small text-dark">
                            <strong>Package Inclusions:</strong> AC cab for all transfers & long drives, hotel accommodation
                            with breakfast, boat cruise, local guide support, and ritual co-ordination.
                        </div>
                    </div>
                </div>
                <div class="modal-footer border-0 p-3 bg-light d-flex justify-content-between">
