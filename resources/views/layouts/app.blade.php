...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="{{ $settings->site_favicon ? asset('storage/' . $settings->site_favicon) : asset('favicon.svg') }}">
...
<body>
                    ...
                    <div class="header-wrap relative w-full">
                                ...
                                <a href="{{ url('/') }}" class="text-decoration-none">
                                    @if(!empty($settings->site_logo))
                                        <img src="{{ asset('storage/' . $settings->site_logo) }}"
                                            alt="{{ $settings->site_name ?? 'visitKashi' }}"
                                            style="max-height: 50px; width: auto; object-fit: contain;">
                                    @else
                                        <span
                                            style="font-family: 'Poppins', sans-serif; font-size: 26px; font-weight: 800; letter-spacing: -0.5px; line-height: 1;">
                                            <span style="color: #F57C00;"><i class="bi bi-water me-1"></i>Kashi</span><span
                                                style="color: #8B1E1E;">Ghoomo</span>
                                        </span>
                                    @endif
                                </a>
                            </div>
                                        ...
                                        <ul class="menu-nav" id="menu-nav">
                                            ...
                                            <li class="menu-item dropdown flex-center gap-1 h-full">
                                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                                    aria-expanded="false">Tour Packages <span
                                                        class="bi bi-chevron-down ms-1" style="font-size: 10px;"></span></a>
                                                <ul
                                                    class="dropdown-menu border-0 shadow-lg p-2 rounded-3 dropdown-menu-premium">
                                                    @forelse($headerDestinations as $dest)
                                                        <li><a class="dropdown-item rounded-2"
                                                                href="{{ route('packages.index', $dest->slug) }}">{{ $dest->name }}
                                                                Tour</a></li>
                                                    @empty
                                                        <li><a class="dropdown-item rounded-2"
                                                                href="{{ route('packages.index') }}">Varanasi Tour</a></li>
                                                    @endforelse
                                                    <li>
                                                        <hr class="dropdown-divider" style="border-color: #E8E8E8;">
                                                    </li>
                                                    <li><a class="dropdown-item rounded-2 fw-bold"
                                                            href="{{ route('packages.index') }}">All Packages</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item dropdown flex-center gap-1 h-full">
                                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                                    aria-expanded="false">Cabs <span class="bi bi-chevron-down ms-1"
                                                    ...
                                                    @forelse($headerCabs as $cab)
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item rounded-2"
                                                                href="{{ route('cabs.show', $cab->slug) }}">
                                                                {{ $icon }} {{ $cab->cab_name }}
                                                            </a>
                                                        </li>
                                                    @empty
                                                        <li><a class="dropdown-item rounded-2"
                                                                href="{{ route('cabs.index') }}">🚗 All Cabs</a></li>
                                                    @endforelse
                                                    <li>
                                                        <hr class="dropdown-divider" style="border-color: #E8E8E8;">
                                                    </li>
                                                    <li><a class="dropdown-item rounded-2 fw-bold"
                                                            href="{{ route('cabs.index') }}">All Cab Services</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item dropdown flex-center gap-1 h-full">
                                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                                    aria-expanded="false">Boats <span class="bi bi-chevron-down ms-1"
                                                        style="font-size: 10px;"></span></a>
                                                <ul
                                                    class="dropdown-menu border-0 shadow-lg p-2 rounded-3 dropdown-menu-premium">
                                                    @forelse($headerBoatPackages as $pkg)
                                                        <li><a class="dropdown-item rounded-2"
                                                                href="{{ route('packages.show', $pkg->slug) }}">{{ $pkg->title }}</a>
                                                        </li>
                                                    @empty
                                                        <li><a class="dropdown-item rounded-2"
                                                                href="{{ route('boat-rides.index') }}">Motor Boat Booking</a>
                                                        </li>
                                                        <li><a class="dropdown-item rounded-2"
                                                                href="{{ route('boat-rides.index') }}">Bajra Boat Booking</a>
                                                        </li>
                                                    @endforelse
                                                    <li>
                                                        <hr class="dropdown-divider" style="border-color: #E8E8E8;">
                                                    ...
                                                    <li><a class="dropdown-item rounded-2 fw-bold"
                                                            href="{{ route('boat-rides.index') }}">All Boat Bookings</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="menu-item flex-center gap-1 h-full">
                                                <a href="{{ route('blogs.index') }}"
                                                    class="nav-link {{ request()->routeIs('blogs') ? 'active' : '' }}">Blogs</a>
                                            </li>
                                            <li class="menu-item flex-center gap-1 h-full">
                        ...
                        <div class="header-ct-right flex-end gap-4 z-5">
                            <a href="{{ route('packages.index') }}"
                                class="btn-book-header d-none d-lg-inline-block text-decoration-none">
                                Book Package
                            </a>
                            <ul class="wrap-login-menu">
                                ...
                                @else
                                    <li class="login dropdown">
                                        ...
                                        <ul
                                            class="dropdown-menu dropdown-menu-end dropdown-menu-premium border-0 shadow-lg mt-2 p-2">
                                            ...
                                            @endif
                                            <li>
                                                <a class="dropdown-item rounded-3 text-danger fw-bold"
                                                    href="{{ route('logout') }}"
                        ...
                        <div class="menu-box">
                            <div class="logo">
                                <a href="{{ url('/') }}" class="text-decoration-none">
                                    ...
                                    @else
                                        <span
                                            style="font-family: 'Poppins', sans-serif; font-size: 24px; font-weight: 800; letter-spacing: -0.5px; line-height: 1;">
                                            <span style="color: #F57C00;"><i class="bi bi-water me-1"></i>Kashi</span><span
                                                style="color: #8B1E1E;">Tourism</span>
                                        </span>
                                    @endif
                                </a>
                            </div>
                                        ...
                                        <div class="phone d-flex">
                                            ...
                                            <div class="content ms-3">
                                                ...
                                                <a href="tel:{{ str_replace(' ', '', $settings->contact_phone) }}"
                                                    class="fw-bold">{{ $settings->contact_phone }}</a>
                                            </div>
                                        </div>
                                    @endif
                                        ...
                                        <div class="email d-flex">
                                            ...
                                            <div class="content ms-3">
                                                ...
                                                <a href="mailto:{{ $settings->contact_email }}"
                                                    class="fw-bold">{{ $settings->contact_email }}</a>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                    ...
                    <div class="container">
                        <div class="row g-4">
                                    ...
                                    <div class="footer-logo mb-4">
                                        <a href="{{ url('/') }}" class="text-decoration-none">
                                            ...
                                            @else
                                                <span
                                                    style="font-family: 'Poppins', sans-serif; font-size: 26px; font-weight: 800; letter-spacing: -0.5px; line-height: 1;">
                                                    <span style="color: #F57C00;">visit</span><span
                                                        style="color: #ffffff;">Kashi</span>
                                                </span>
                                            @endif
                                        </a>
                                    </div>
                                    <p class="text-white-50 mb-4"
                                        style="font-size: 13.5px; line-height: 1.6; text-align: justify;">
                                        India's most trusted travel partner for Varanasi — hotel stays, cab hire, boat
                                        rides, Ganga Aarti & pilgrimage tours.
                                    </p>
                                    @if($settings->address)
                                        <p class="text-white-50 mb-3" style="font-size: 13px; line-height: 1.5;">
                                            <i class="bi bi-geo-alt-fill text-warning me-2"
                                                style="color: #D4AF37 !important;"></i> {{ $settings->address }}
                                        </p>
                                    @endif
                                    @if($settings->contact_phone)
                                        <p class="text-white-50 mb-3" style="font-size: 13px;">
                                            <i class="bi bi-telephone-fill text-warning me-2"
                                                style="color: #D4AF37 !important;"></i>
                                            <a href="tel:{{ str_replace(' ', '', $settings->contact_phone) }}"
                                                class="text-white text-decoration-none">{{ $settings->contact_phone }}</a>
                                        </p>
                                    @endif
                                    @if($settings->contact_email)
                                        <p class="text-white-50 mb-4" style="font-size: 13px;">
                                            <i class="bi bi-envelope-fill text-warning me-2"
                                                style="color: #D4AF37 !important;"></i>
                                            <a href="mailto:{{ $settings->contact_email }}"
                                                class="text-white text-decoration-none">{{ $settings->contact_email }}</a>
                                        </p>
                                    @endif
                                    <div class="footer-socials">
                                        <ul class="list-social d-flex gap-3 p-0" style="list-style:none;">
                                            @if($settings->facebook_url)
                                                <li><a href="{{ $settings->facebook_url }}" target="_blank"
                                                        class="text-white fs-5" aria-label="Facebook"><i
                                                            class="bi bi-facebook"></i></a></li>
                                            @endif
                                            @if($settings->instagram_url)
                                                <li><a href="{{ $settings->instagram_url }}" target="_blank"
                                                        class="text-white fs-5" aria-label="Instagram"><i
                                                            class="bi bi-instagram"></i></a></li>
                                            @endif
                                            @if($settings->twitter_url)
                                                <li><a href="{{ $settings->twitter_url }}" target="_blank"
                                                        class="text-white fs-5" aria-label="Twitter"><i
                                                            class="bi bi-twitter"></i></a></li>
                                            @endif
                                            @if($settings->whatsapp_number)
                                                <li><a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number) }}"
                                                        target="_blank" class="text-white fs-5" aria-label="WhatsApp"><i
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                <div class="widget-box">
                                    <div class="text-white h5 fw-bold mb-4"
                                        style="border-bottom: 2px solid #8B1E1E; padding-bottom: 8px; display: inline-block; font-size: 15px;">
                                        KASHI YATRA</div>
                                    <ul class="tour-list p-0" style="list-style:none; line-height: 2;">
                                        @forelse($headerYatraPackages as $pkg)
                                            <li><a href="{{ route('packages.show', $pkg->slug) }}"
                                                    class="text-white-50 text-decoration-none hover-text-warning"
                                                    style="font-size: 13px;">{{ $pkg->title }}</a></li>
                                        @empty
                                            <li><a href="{{ route('packages.index') }}"
                                                    class="text-white-50 text-decoration-none hover-text-warning"
                                                    style="font-size: 13px;">Varanasi Yatra Packages</a></li>
                                        @endforelse
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                <div class="widget-box">
                                    ...
                                    <ul class="tour-list p-0" style="list-style:none; line-height: 2;">
                                        @forelse($headerCabs as $cab)
                                            <li><a href="{{ route('cabs.show', $cab->slug) }}"
                                                    class="text-white-50 text-decoration-none hover-text-warning"
                                                    style="font-size: 13px;">{{ $cab->cab_name }}</a></li>
                                        @empty
                                            <li><a href="{{ route('cabs.index') }}"
                                                    class="text-white-50 text-decoration-none hover-text-warning"
                                                    style="font-size: 13px;">All Cab Booking Services</a></li>
                                        @endforelse
                                        <li><a href="{{ route('cabs.index') }}"
                                                class="text-white-50 text-decoration-none hover-text-warning"
                                                style="font-size: 13px; font-weight:bold;">All Cab Services</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="tour-list p-0" style="list-style:none; line-height: 2;">
                                        @forelse($headerBoatPackages as $pkg)
                                            <li><a href="{{ route('packages.show', $pkg->slug) }}"
                                                    ...
                                                    style="font-size: 13px;">{{ $pkg->title }}</a></li>
                                        @empty
                                            <li><a href="{{ route('boat-rides.index') }}"
                                                    class="text-white-50 text-decoration-none hover-text-warning"
                                                    style="font-size: 13px;">Boat Rides & Cruises</a></li>
                                        @endforelse
                                        <li><a href="{{ route('boat-rides.index') }}"
                                                class="text-white-50 text-decoration-none hover-text-warning"
                                                style="font-size: 13px; font-weight:bold;">All Boat Bookings</a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="widget-box">
                                    ...
                                    <ul class="tour-list p-0" style="list-style:none; line-height: 2;">
                                        <li><a href="{{ route('about') }}"
                                                class="text-white-50 text-decoration-none hover-text-warning"
                                                style="font-size: 13px;">About Us</a></li>
                                        <li><a href="{{ route('privacy-policy') }}"
                                                class="text-white-50 text-decoration-none hover-text-warning"
                                                style="font-size: 13px;">Privacy Policy</a></li>
                                        <li><a href="{{ route('terms-conditions') }}"
                                                class="text-white-50 text-decoration-none hover-text-warning"
                                                style="font-size: 13px;">Terms &amp; Conditions</a></li>
                                        <li><a href="{{ route('faq') }}"
                                                class="text-white-50 text-decoration-none hover-text-warning"
                                                style="font-size: 13px;">FAQs</a></li>
                                        <li><a href="{{ route('contact') }}"
                                                class="text-white-50 text-decoration-none hover-text-warning"
                                                style="font-size: 13px;">Contact Us</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="content-bottom d-flex justify-content-between align-items-center flex-wrap gap-3">
                            ...
                            <ul class="menu-bottom flex-center gap-3 p-0 m-0" style="list-style:none;">
                                <li><a href="{{ route('terms-conditions') }}"
                                        class="item-bottom text-white-50 text-decoration-none hover-text-warning"
                                        style="font-size: 12px;">Terms of use</a></li>
                                <li><a href="{{ route('privacy-policy') }}"
                                        class="item-bottom text-white-50 text-decoration-none hover-text-warning"
                                        style="font-size: 12px;">Privacy policy</a></li>
                                <li><a href="{{ route('faq') }}"
                                        class="item-bottom text-white-50 text-decoration-none hover-text-warning"
                                        style="font-size: 12px;">FAQs</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- Login Modal -->
    <div class="modal modal-account fade" id="modalLogin" aria-modal="true" role="dialog" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="flat-account">
                    ...
                    <form class="form-account" id="loginForm"
                        onsubmit="event.preventDefault(); alert('Login simulated successfully!');">
                        <div class="title-box">
                            {{-- <h1>Login</h1> --}}
                        ...
                        <div class="box">
                            <fieldset class="box-fieldset">
                                <label>Email</label>
                                <div class="ip-field">
                                    <img src="{{ asset('frontend-theme/images/icons/mail.svg') }}" alt="icons"
                                        class="icon">
                            ...
                            <fieldset class="box-fieldset">
                                ...
                                <div class="ip-field">
                                    <img src="{{ asset('frontend-theme/images/icons/icon-lock.svg') }}" alt="icons"
                                        class="icon">
            ...
            <div class="modal-content">
                <div class="flat-account">
                    ...
                    <form class="form-account"
                        onsubmit="event.preventDefault(); alert('Registration simulated successfully!');">
                        <div class="title-box">
                            {{-- <h1>Register</h1> --}}
                        ...
                        <div class="box">
                            ...
                            <fieldset class="box-fieldset">
                                <label>Password</label>
                                <div class="ip-field">
                                    <img src="{{ asset('frontend-theme/images/icons/icon-lock.svg') }}" alt="icon"
                                        class="icon">
                        ...
                        <div class="box box-btn">
                            ...
                            <div class="text text-center">
                                ...
                                <a href="#modalLogin" data-bs-toggle="modal" data-bs-dismiss="modal"
                                    class="text_primary">Login</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <!-- Forgot Modal -->
    <div class="modal modal-account fade" id="modalForgot" aria-modal="true" role="dialog" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="flat-account">
                    ...
                    <form class="form-account" onsubmit="event.preventDefault();">
                        ...
                        <div class="box box-btn">
                            <a href="#modalOTP" data-bs-toggle="modal" data-bs-dismiss="modal"
                                class="tf-btn primary w-100 text-center text-white py-2 text-decoration-none">Send Reset
                                Link</a>
                            <div class="text text-center">
    ...
    <!-- OTP Modal -->
    <div class="modal modal-account fade" id="modalOTP" aria-modal="true" role="dialog" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="flat-account">
                    ...
                    <form class="form-account otp-form" id="otpForm" onsubmit="event.preventDefault();">
                        ...
                        <div class="box box-btn">
                            <a href="#modalResetPassword" data-bs-toggle="modal" data-bs-dismiss="modal"
                                class="tf-btn primary w-100 text-center text-white py-2 text-decoration-none"
                                id="btnOtpContinue">Continue</a>
                        </div>
                        <div class="text text-center">
    ...
    <div class="modal modal-account fade" id="modalResetPassword" aria-modal="true" role="dialog" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="flat-account">
                    ...
                    <form class="form-account" onsubmit="event.preventDefault();">
                        ...
                        <div class="box box-btn">
                            <a href="#modalLogin" data-bs-toggle="modal"
                                class="tf-btn primary w-100 text-center text-white py-2 text-decoration-none">Confirm</a>
                        </div>
                        <div class="text text-center">
