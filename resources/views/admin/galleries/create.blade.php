        ...
        <div class="card-body p-4 p-lg-5">
            <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title"
                                ...
                                value="{{ old('title') }}" placeholder="E.g. Presidential Suite Interior">
                            @error('title')
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="alt_text"
                                ...
                                value="{{ old('alt_text') }}" placeholder="Alt text description">
                            @error('alt_text')
                            <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                ...
                <div class="mt-4 pt-4 border-top">
                    <button type="submit" class="btn btn-navy px-5 py-3 fw-bold rounded-pill shadow-premium">UPLOAD
                        IMAGE</button>
