            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="alt_text" class="form-control form-control-lg @error('alt_text') is-invalid @enderror" value="{{ old('alt_text') }}" placeholder="Alt text description">
