        ...
        <form action="{{ route('admin.hotels.update', $hotel) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                        ...
                        <div class="col-md-3 col-sm-6 image-container">
                            <div class="card h-100 border">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <input type="text" name="alt_text[{{ $img }}]" class="form-control form-control-sm" value="{{ $hotel->alt_text[$img] ?? '' }}" placeholder="Image description">
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title', $hotel->meta_title) }}" placeholder="SEO title for search results">
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Meta Description</label>
                    <textarea name="meta_description" rows="3" class="form-control" placeholder="Describe the hotel in 150-160 characters...">{{ old('meta_description', $hotel->meta_description) }}</textarea>
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Meta Keywords</label>
                    <input type="text" name="meta_keywords" class="form-control" value="{{ old('meta_keywords', $hotel->meta_keywords) }}" placeholder="keyword1, keyword2, keyword3">
                </div>
                <div class="col-12">
                    <label class="form-label fw-bold">Custom Meta Tags (HTML)</label>
                    <textarea name="meta_tags" class="form-control" rows="4" placeholder="Enter custom HTML meta tags (e.g. Open Graph, Canonical, JSON-LD)">{{ old('meta_tags', $hotel->meta_tags) }}</textarea>
                </div>
            </div>
            <div class="mt-4">
