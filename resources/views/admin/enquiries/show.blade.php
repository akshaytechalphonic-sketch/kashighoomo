...
<div class="row g-4">
            ...
            <div class="card-header bg-white border-bottom py-4">
                <div class="d-flex align-items-start gap-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center" 
                         style="width: 56px; height: 56px; background: linear-gradient(135deg, #e8900a, #be7007); color: white; font-size: 1.5rem; font-weight: 700; flex-shrink: 0;">
                        {{ strtoupper(substr($enquiry->name, 0, 1)) }}
                    </div>
                    <div class="flex-grow-1">
                        <h4 class="mb-1 fw-bold" style="color: #1f2937;">{{ $enquiry->name }}</h4>
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4 pb-4 border-bottom">
                    <div class="d-flex align-items-center gap-2 mb-2">
                        <i class="bi bi-tag-fill" style="color: #e8900a;"></i>
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <i class="bi bi-chat-left-text-fill" style="color: #e8900a;"></i>
                ...
                <!-- Cab Booking Info (if exists) -->
                @if($enquiry->cab_booking_package_id && $enquiry->cabBookingPackage)
                <div class="alert alert-warning d-flex align-items-start gap-3 border-0 text-dark" style="background: #fff8f0; border-left: 4px solid #e8900a !important;">
                    <i class="bi bi-car-front fs-4" style="color: #e8900a;"></i>
                    <div>
                        <h6 class="fw-bold mb-1" style="color: #e8900a;">Cab Booking Enquiry</h6>
                        <p class="mb-1"><strong>Cab / Vehicle:</strong> {{ $enquiry->cabBookingPackage->cab_name }} ({{ $enquiry->cabBookingPackage->vehicle_type }})</p>
                        <p class="mb-1"><strong>Capacity:</strong> {{ $enquiry->cabBookingPackage->seating_capacity }} Seater</p>
                        <p class="mb-1"><strong>Price:</strong> ₹{{ number_format($enquiry->cabBookingPackage->price) }} / day</p>
                        @if($enquiry->travel_date)
                            <p class="mb-1"><strong>Travel Date:</strong> {{ $enquiry->travel_date->format('M d, Y') }}</p>
                        @endif
                        @if($enquiry->adults || $enquiry->children)
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow-sm border-0 rounded-4 mb-4">
            <div class="card-header bg-white border-bottom py-3">
                <h6 class="mb-0 fw-bold text-uppercase" style="font-size: 0.75rem; letter-spacing: 1px; color: #6c757d;">
                    <i class="bi bi-person-lines-fill me-2" style="color: #e8900a;"></i>Contact Information
                </h6>
            </div>
            <div class="card-body p-4">
                <div class="d-flex flex-column gap-3">
                    ...
                    <div>
                        ...
                        <a href="mailto:{{ $enquiry->email }}" 
                           ...
                           style="background: #f8f9fa; color: #1f2937; font-weight: 600; transition: all 0.2s;"
                           onmouseover="this.style.background='#e9ecef'"
                           onmouseout="this.style.background='#f8f9fa'">
                            <i class="bi bi-envelope-fill" style="color: #e8900a;"></i>
                    ...
                    <div>
                        ...
                        <a href="tel:{{ $enquiry->phone }}" 
                           ...
                           onmouseover="this.style.background='#e9ecef'"
                           onmouseout="this.style.background='#f8f9fa'">
                            <i class="bi bi-telephone-fill" style="color: #e8900a;"></i>
        ...
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-header bg-white border-bottom py-3">
                <h6 class="mb-0 fw-bold text-uppercase" style="font-size: 0.75rem; letter-spacing: 1px; color: #6c757d;">
                    <i class="bi bi-gear-fill me-2" style="color: #e8900a;"></i>Actions
                </h6>
            </div>
            <div class="card-body p-4">
                <div class="d-flex flex-column gap-3">
                    ...
                    <form action="{{ route('admin.enquiries.destroy', $enquiry) }}" 
                        ...
                        <button type="submit" 
                                ...
                                style="border-color: #e8900a; color: #e8900a; font-weight: 600;">
