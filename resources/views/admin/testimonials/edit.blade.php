...
@section('content')
    <div class="mb-4">
        <a href="{{ route('admin.testimonials.index') }}" class="text-decoration-none small fw-bold"><i
                class="bi bi-arrow-left"></i> BACK TO TESTIMONIALS</a>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            @if ($testimonial->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $testimonial->image) }}" class="rounded-3"
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted">
                                Paste any YouTube URL. It will automatically be converted to an embed URL.
                            </small>
                        </div>
                    </div>
