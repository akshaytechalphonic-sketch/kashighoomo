<aside id="sidebar">
    <div class="sidebar-header p-4 d-flex align-items-center">
       <div>
            <img src="{{ asset('storage/' . $settings->site_logo) }}" alt="Kashi Tourism Logo" style="height: 50px;">
        </div>
    </div>
    ...
    <div class="sidebar-menu flex-grow-1 overflow-y-auto mt-2">
        ...
        <a href="{{ route('admin.cab-packages.index') }}" class="sidebar-link {{ request()->routeIs('admin.cab-packages.*') ? 'active' : '' }}">
            <i class="bi bi-car-front"></i>
            <span class="sidebar-text">Cab Packages</span>
        </a>
