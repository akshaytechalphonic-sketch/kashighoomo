            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="cab_booking_package_id" class="form-select @error('cab_booking_package_id') is-invalid @enderror">
                        ...
                        <option value="{{ $cab->id }}" {{ old('cab_booking_package_id') == $cab->id ? 'selected' : '' }}>{{ $cab->cab_name }} ({{ $cab->vehicle_type }})</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="start_location" class="form-control" value="{{ old('start_location') }}" placeholder="e.g. Kashi / Varanasi">
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="itinerary" rows="8" class="form-control" placeholder="Day 1 | Arrival in Varanasi | Rest and acclimatize to high altitude. Meet group in evening.&#10;Day 2 | Varanasi to Sham Valley | Explore Sham Valley, visit Alchi monastery and Magnetic Hill.&#10;Day 3 | Varanasi to Nubra Valley | Drive through Khardung La Pass (highest motorable road).">{{ old('itinerary') }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="meta_title" class="form-control @error('meta_title') is-invalid @enderror" value="{{ old('meta_title') }}" placeholder="e.g. Best Bike Tour in Kashi | Kashi Tourism">
                ...
                <div class="col-12">
                    ...
                    <textarea name="meta_keywords" rows="2" class="form-control @error('meta_keywords') is-invalid @enderror" placeholder="e.g. bike tour Kashi, Varanasi tour, motorbiking Kashi">{{ old('meta_keywords') }}</textarea>
