    ...
    <div class="row g-5">
        <div class="col-lg-12">
            <h2 class="fw-bold text-navy mb-4">
                Explore Our <span style="color:#e8900a;">{{ $service->title }}</span> Services
            </h2>
                    ...
                    <div class="card border rounded-4 overflow-hidden shadow-sm" style="transition: all 0.3s ease;">
                        <div class="row g-0">
                            ...
                            <div class="col-md-7 col-lg-8 p-4 d-flex flex-column justify-content-between">
                                <div>
                                    <h4 class="fw-bold mb-3" style="color: #e8900a; text-transform: uppercase; letter-spacing: 0.5px;">{{ $pkg->title }}</h4>

                                    <div class="row g-3 mb-4">
                                        <div class="col-6 col-sm-4">
                                            <span class="text-muted d-block small text-uppercase fw-semibold" style="font-size: 10px;">Duration</span>
                                            <span class="fw-bold text-dark"><i class="bi bi-clock me-1" style="color:#e8900a;"></i> {{ $pkg->duration }}</span>
                                        </div>
                                        @if($pkg->best_season)
                                        <div class="col-6 col-sm-4">
                                            <span class="text-muted d-block small text-uppercase fw-semibold" style="font-size: 10px;">Best Season</span>
                                            <span class="fw-bold text-dark"><i class="bi bi-sun me-1" style="color:#e8900a;"></i> {{ $pkg->best_season }}</span>
                                        </div>
                                        @endif
                                        @if($pkg->difficulty)
                                        <div class="col-6 col-sm-4">
                                            <span class="text-muted d-block small text-uppercase fw-semibold" style="font-size: 10px;">Grade</span>
                                            <span class="fw-bold text-dark"><i class="bi bi-bar-chart me-1" style="color:#e8900a;"></i> {{ $pkg->difficulty }}</span>
                                        </div>
                                        @endif
                                        ...
                                        <div class="col-6 col-sm-4">
                                            ...
                                            <span class="fw-bold text-dark"><i class="bi bi-geo me-1" style="color:#e8900a;"></i> {{ $pkg->start_location }}</span>
                                        </div>
                                        @endif
                                        @if($pkg->destination)
                                        <div class="col-12 col-sm-8">
                                            <span class="text-muted d-block small text-uppercase fw-semibold" style="font-size: 10px;">Destinations Covered</span>
                                            <span class="fw-bold text-dark"><i class="bi bi-map me-1" style="color:#e8900a;"></i> {{ $pkg->destination->name }}</span>
                                        </div>
                                        @endif
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 pt-3 border-top">
                                    <div>
                                        ...
                                        <span class="h4 fw-bold mb-0" style="color:#1f2937;">₹{{ number_format($pkg->price) }}</span>
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('packages.show', $pkg->slug) }}#enquiry-form" class="btn rounded-pill px-4 fw-bold" style="background:#e8900a; color:#fff; font-size:0.8rem; border:none;">BOOK NOW</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5 col-lg-4 position-relative" style="min-height: 250px;">
                                ...
                                <div class="position-absolute top-0 end-0 m-3 text-white rounded-circle d-flex align-items-center justify-content-center flex-column shadow"
                                     style="width:70px; height:70px; background:#e8900a;">
