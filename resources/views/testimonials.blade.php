...
<div class="page-header" style="background-image: url('{{ $sections->first() && $sections->first()->image ? asset('storage/' . $sections->first()->image) : asset('frontend-theme/images/backgrounds/bg-about-us.jpg') }}');">
