...
<div class="hero-section" style="background-image: url('{{ $banner && $banner->image ? asset('storage/' . $banner->image) : 'https://images.unsplash.com/photo-1598897516650-df69c2fdd6a7?auto=format&fit=crop&q=80&w=1920' }}'); min-height: 40vh; padding: 120px 0 60px; display: flex; align-items: center;">
    ...
    <div class="container hero-content text-center">
        <div class="fade-up">
            <span class="badge mb-3 px-3 py-2 rounded-pill text-uppercase ls-1 text-white" style="background:#e8900a;">Curated Deals</span>
            <h1 class="display-3 fw-bold text-white mb-3">{{ $banner->title ?? 'Exclusive Offers' }}</h1>
            <p class="lead text-white opacity-90 max-w-700 mx-auto">{!! strip_tags($banner->description ?? 'Get premium Kashi bike expeditions, luxury stays, and customized tour packages at exclusive rates.') !!}</p>
        </div>
    </div>
</div>
...
<div class="container py-5 mt-5">
    <div class="row g-4">
            ...
            <div class="card-premium h-100 shadow-lg border-0 overflow-hidden">
                <div class="row g-0 h-100">
                    ...
                    <div class="col-md-7 p-4 p-lg-5 d-flex flex-column justify-content-center">
                        <span class="badge fw-bold mb-3 align-self-start py-2 px-3 rounded-pill text-white" style="background:#e8900a;">{{ $offer->discount_text ?? 'SPECIAL DEAL' }}</span>
        ...
        <div class="col-12 mt-5">
            <div class="rounded-5 p-5 shadow-lg position-relative overflow-hidden text-white" style="background: linear-gradient(135deg, #1f2937 0%, #1a3a5c 100%);">
                <div class="row align-items-center g-4 position-relative" style="z-index: 2;">
                    <div class="col-lg-8">
                        <h3 class="fw-bold mb-3">Group discount offer</h3>
                        <p class="opacity-90 mb-0">Join our newsletter today to get **Group and custom discounts** on your booking. Plus, enjoy complimentary airport pickup & drop-off in Varanasi based on availability.</p>
                    </div>
                    <div class="col-lg-4 text-lg-end">
                        <a href="{{ route('contact') }}" class="btn btn-light btn-lg rounded-pill px-5 fw-bold text-primary-blue shadow-md" style="color: #1f2937 !important;">Contact Us</a>
                    </div>
                </div>
