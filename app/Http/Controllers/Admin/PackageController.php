...
class PackageController extends Controller
{
    ...
    public function create()
    {
        ...
        $cabPackages = \App\Models\CabBookingPackage::where('status', true)->get();
        return view('admin.packages.create', compact('destinations', 'services', 'cabPackages'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'cab_booking_package_id' => 'nullable|integer',
        ...
        Package::create([
            ...
            'cab_booking_package_id' => $request->cab_booking_package_id,
            'title'            => $request->title,
            'slug'             => $slug,
    ...
    public function edit(Package $package)
    {
        ...
        $services = Service::where('status', true)->get();
        $cabPackages = \App\Models\CabBookingPackage::where('status', true)->get();
        return view('admin.packages.edit', compact('package', 'destinations', 'services', 'cabPackages'));
    }
